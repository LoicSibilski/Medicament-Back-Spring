...
public class MedicServiceImpl implements MedicService{
	...
	public Map<String, String> getMapNom (ObjectMapper mapper,JsonNode medicTmp) throws JsonProcessingException, IllegalArgumentException{
		Map<String,String> mapNom = mapper.treeToValue(medicTmp.get("nom"), Map.class);
		System.out.println("maaaaap nom => + " + mapNom.values());
		return mapNom;
	}
	
	public Map<String, String> getMapDuree (ObjectMapper mapper,JsonNode medicTmp) throws JsonProcessingException, IllegalArgumentException{
	...
	public Map<String, String> getMapFrequence (ObjectMapper mapper,JsonNode medicTmp) throws JsonProcessingException, IllegalArgumentException{
